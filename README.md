...
> 给 **4-10 岁**孩子的双语识字启蒙应用：汉字 **204 字**（4 级）+ 英语 **173 词**（10 类），
...
| 级别 | 适合年龄 | 内容 | 字数 |
| --- | --- | --- | --- |
| 🌱 启蒙篇 | 4-5 岁 | 象形字、数字、身体、自然、天气 | 51 |
| 🌿 进阶篇 | 5-6 岁 | 一年级上册常用字、颜色、动物、食物、动作 | 65 |
| 🌳 提升篇 | 6-8 岁 | 四季、家人称谓、生活用品、学习用品 | 44 |
| 🏆 挑战篇 | 8-10 岁 | 城乡、职业、抽象概念、时间 | 44 |
...
欢迎 PR：补充词库、增加玩法（笔顺动画、听写模式）、优化无障碍、补充多语言。
